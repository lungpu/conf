...
(custom-set-variables
 ...
 '(package-selected-packages
   '(fish-mode org-tag-beautify org-view-mode company-jedi company-org-block modus-themes org-indent org-modern-mode diminish dimmer org-variable-pitch variable-pitch company-box company-quickhelp company-ansible company-fuzzy company-nginx company-shell company-terraform company-web lsp-mode yasnippet lsp-treemacs helm-lsp projectile hydra flycheck company avy which-key helm-xref dap-mode zenburn-theme json-mode))
