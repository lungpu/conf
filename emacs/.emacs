...
(global-set-key (kbd "C-x C-b") 'sidebar-buffers-open)
...
(custom-set-variables
 ...
 '(org-agenda-files '("/home/lungpu/notes/basb/msb.org"))
 '(package-selected-packages
   '(org-tag-beautify org-view-mode company-jedi company-org-block modus-themes org-indent org-modern-mode diminish dimmer org-variable-pitch variable-pitch company-box company-quickhelp company-ansible company-fuzzy company-nginx company-shell company-terraform company-web lsp-mode yasnippet lsp-treemacs helm-lsp projectile hydra flycheck company avy which-key helm-xref dap-mode zenburn-theme json-mode))
...
(use-package org
  ...
  ;; variable pitch for org
  (org-variable-pitch-minor-mode)

  (setq org-agenda-files '("~/notes/basb/msb.org"))
...
(defun push-gtd()
  (interactive)
  (call-process "pushmsb.sh"))
(global-set-key "\C-cp" 'push-gtd)

(defun pull-gtd()
  (interactive)
  (call-process "pullmsb.sh"))

(setq org-capture-templates
      '(("i" "general INBOX item" entry (file+headline "~/notes/basb/msb.org" "0 INBOX")
	 "** %? %^G\n")
))
...
(custom-set-faces
 ...
 '(org-level-1 ((t (:extend nil :foreground "light sky blue" :height 1.2 :family "Noto Serif Display Bold"))))
...
;; emms
(emms-all)
(setq emms-player-list '(emms-player-vlc) emms-info-functions '(emms-info-native))
